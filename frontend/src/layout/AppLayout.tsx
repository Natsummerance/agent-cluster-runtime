...
export default function AppLayout() {
  ...
  const menuItems = useMemo(
    () => [
      { key: '/', icon: <RocketOutlined />, label: intl.formatMessage({ id: 'layout.menu.quickrun', defaultMessage: '🚀 极速开发' }) },
      { key: '/dashboard', icon: <DashboardOutlined />, label: intl.formatMessage({ id: 'layout.menu.dashboard', defaultMessage: '📊 工作台概览' }) },
      { key: '/projects', icon: <FolderOutlined />, label: intl.formatMessage({ id: 'layout.menu.projects', defaultMessage: '📁 项目管理' }) },
      { key: '/artifacts', icon: <FolderOpenOutlined />, label: intl.formatMessage({ id: 'layout.menu.workspace', defaultMessage: '📝 工作区产物' }) },
      { key: '/memory', icon: <DatabaseOutlined />, label: intl.formatMessage({ id: 'layout.menu.memory', defaultMessage: '🧠 记忆库' }) },
      { key: '/evolution', icon: <ExperimentOutlined />, label: intl.formatMessage({ id: 'layout.menu.evolution', defaultMessage: '🧬 进化闭环' }) },
      { key: '/integrations', icon: <ApiOutlined />, label: intl.formatMessage({ id: 'layout.menu.integrations', defaultMessage: '🔌 工具集成' }) },
      { key: '/audit', icon: <AuditOutlined />, label: intl.formatMessage({ id: 'layout.menu.audit', defaultMessage: '📜 审计日志' }) },
      { key: '/settings', icon: <SettingOutlined />, label: intl.formatMessage({ id: 'layout.menu.settings', defaultMessage: '⚙️ 系统设置' }) },
      {
